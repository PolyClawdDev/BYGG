  ...
  return (
    <main className="bg-white relative overflow-x-hidden">
      <div className="min-h-[100dvh] p-4">
        <div className="w-full min-h-[calc(100dvh-2rem)] animate-subtle-bg rounded-2xl flex flex-col">
          {/* Hamburger Menu */}
          <button
          ...
          <div className="flex-1 flex flex-col justify-center px-4 md:px-8 py-4 md:py-6" key="contact-page-v3">
            <div className="w-full max-w-5xl mx-auto">
              ...
              {/* Two-column: info + booking form. Aggressive spacing
                  tightening so all content lives inside the
                  full-viewport hero card without clipping. */}
