 ...
 * menu on the site (home, kontakt, interior-design-homestyling). Pulls
 * its data from the shared `SOCIAL_LINKS` registry so the Facebook URL
 * (and any future Instagram/TikTok/LinkedIn URLs) stays in sync with
 * the footer automatically.
 *
 * External links (http/https) open in a new tab with rel=noopener.
 * Placeholder links (href "#") stay as anchors so the icon row remains
 * visually balanced while we wait for real profile URLs.
 */
